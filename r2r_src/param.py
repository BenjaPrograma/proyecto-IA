...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument("--replace_object", action='store_const', default=False, const=True)

        # aux loss
        self.parser.add_argument("--aux_option", action='store_const', default=False, const=True)
        self.parser.add_argument("--matins_vl_ctx", action='store_const', default=False, const=True)
        ...
        self.parser.add_argument('--epMatWeight', type=float, default=0)
        self.parser.add_argument('--matins_lr', type=float, default=0.0001)
